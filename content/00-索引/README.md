...
| **02-模块/** | DQN、PPO、SAC、GRPO 等算法的深度笔记 | 算法详解 |
...
- [[01-原子/KL散度]]：Forward/Reverse KL 的直觉与数学，RL 约束的核心理论
...
- [[按优化对象]]：Value-Based / Policy-Based / Actor-Critic
- [[按策略类型]]：On-Policy / Off-Policy
- [[按动作空间]]：Discrete / Continuous
- [[按数据来源]]：Online / Offline
- [[按模型依赖]]：Model-Free / Model-Based
- ：Tabular / Function Approximation

## 🔬 深度专题（04-演化综述/）

- [[03-流程/Value-Based演化史]]：从 Bellman 到 Diffusion-RL，18 个方法的完整演化链
- [[03-流程/Policy-AC演化史]]：从 REINFORCE 到 DAPO，14 个方法 + 三条演化线（通用策略优化 / 连续控制 / LLM 对齐）
- [[03-流程/Model-Based演化史]]：从 DP 到 Genie/GameNGen，21 个方法 + 三条演化线（动力学模型 / 世界模型 / 搜索规划）
- [[03-流程/Offline-RL与RLHF演化史]]：从 BC 到 SimPO，21+ 个方法 + 两大主线（离线数据利用 / 偏好优化）
- [[03-流程/MARL全景综述]]：从博弈论到 CICERO，涵盖值分解、策略梯度、通信、自我博弈等 6 大板块
