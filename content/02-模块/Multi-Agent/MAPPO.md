...
> Multi-Agent [[02-模块/Policy-Based/PPO|PPO]] (Yu 2022). 将 [[02-模块/Policy-Based/PPO|PPO]] 扩展到多智能体场景，性能出奇地好，是 MARL 的强基线。
...
把 [[02-模块/Policy-Based/PPO|PPO]] 应用到多智能体，配合一系列工程最佳实践，就能达到甚至超过复杂的 off-policy 方法。关键发现：[[02-模块/Policy-Based/PPO|PPO]] 在 MARL 中被低估了。通过 value normalization、advantage normalization、大批量训练、正交初始化、critic 使用全局状态等技巧，MAPPO 成为事实上的标准基线。
...
- [[PPO]] — 单智能体基础
- [[MADDPG]] — CTDE + [[02-模块/Actor-Critic/DDPG|DDPG]] 的前身
- [[QMIX]] — 值分解路线的对照方法
- [[03-流程/MARL全景综述|IPPO]] — 完全独立的 [[02-模块/Policy-Based/PPO|PPO]]，更极端的简单基线
